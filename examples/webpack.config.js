...
var webpack_isomorphic_tools_plugin = new Webpack_isomorphic_tools_plugin(require('./webpack-isomorphic'));
if (ENV === 'development') {
...
module.exports = merge(common, envs[ENV] || envs['development']);
